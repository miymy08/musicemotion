...
<html>
  <head>
    ...
    <link rel="stylesheet" href="ytmodal.css">
    ...
    <div class="content">
      ...
      <ul class="w3-ul w3-block songtable">
        ...
        <li class="w3-padding-16">
          <a href="musicdetail.php?m_code=<?php echo $music_code ?>">
            <img src="img/albumcover/<?php echo $row_music['m_img']; ?>" class="w3-left w3-margin-right" style="width:100px">
            <span class="w3-xlarge songtitle"><?php echo $row_music['m_title']; ?></span><br>
            <span class="w3-large"><?php echo $singer_string; ?></span><br>
            <span><?php echo $row_music['m_year']; ?></span>
            <a class="video-btn" data-toggle="modal" data-src="https://www.youtube.com/embed/<?php echo $row_music['m_audiofile']; ?>" data-target="#myModal">
              <div class="w3-tooltip" style="position:absolute;right:0;top:0;width:130px;height:130px;background-color:red;border-bottom:1px solid white;overflow:hidden;display: flex;align-items: center;">
                ...
                <span style="position:absolute;bottom:0;width:100%;" class="w3-text w3-tag"><?php echo $row_music['m_title']; ?></span>
